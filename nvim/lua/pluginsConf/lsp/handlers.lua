...
local function lsp_keymaps(bufnr)
  ...
  vim.api.nvim_buf_set_keymap(bufnr, "n", "ê", '<cmd>lua vim.diagnostic.goto_prev({ border = "rounded" })<CR>', opts)
  ...
  vim.api.nvim_buf_set_keymap(bufnr, "n", "ë", '<cmd>lua vim.diagnostic.goto_next({ border = "rounded" })<CR>', opts)
